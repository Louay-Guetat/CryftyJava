...
public class AfficheTransactionBOController implements Initializable {
    @javafx.fxml.FXML
    ...
    public void getTransactionClient()
    {
        ...
        TableTransaction.setItems(transactionService.getTransactions());
    ...
    public void search()
    {
        ...
        FilteredList<Transaction> filteredData = new FilteredList<>(transactionService.getTransactions(), b -> true);
